  ...
  return (
    ...
    >
      <img
        src={imgUrl}
        alt="planet-04"
        className="absolute w-full h-full object-cover rounded-[24px] mix-blend-normal hover:mix-blend-exclusion"
      />
      {active !== id ? (
        <h3 
        ...
        <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
           ...
           <p className="font-semibold text-[16px] leading-[20px] text-white uppercase">
            Enter the Metaverse
           </p>
